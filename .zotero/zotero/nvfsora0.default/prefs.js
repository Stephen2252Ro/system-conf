...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1631089316);
user_pref("app.update.lastUpdateTime.background-update-timer", 1631089556);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1631089436);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1631089196);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1631089076);
...
user_pref("extensions.zotero.dataDir", "/home/stephen/Zotero");
user_pref("extensions.zotero.firstRun.skipFirefoxProfileAccessCheck", true);
user_pref("extensions.zotero.firstRun2", false);
user_pref("extensions.zotero.lastViewedFolder", "C21");
user_pref("extensions.zotero.lastWebDAVOrphanPurge", 1631089895);
...
user_pref("extensions.zotero.sync.server.username", "Stephen2252");
user_pref("extensions.zotero.sync.storage.protocol", "webdav");
user_pref("extensions.zotero.sync.storage.url", "ena.teracloud.jp/dav");
user_pref("extensions.zotero.sync.storage.username", "Stephen2252");
...
user_pref("extensions.zoteroOpenOfficeIntegration.version", "5.0.25.SA.5.0.96.3");
user_pref("extensions.zotfile.source_dir", "/home/stephen/Desktop");
user_pref("extensions.zotfile.source_dir_ff", false);
user_pref("extensions.zotfile.tablet", true);
user_pref("extensions.zotfile.tablet.dest_dir", "/home/stephen/Dropbox/Tablet-paper");
